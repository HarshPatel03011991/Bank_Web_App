...
namespace Bank_Web_App
{
    public partial class Employee_Login : System.Web.UI.Page
    {
        ...
        protected void Login_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string checkuser = "select count (*) from EmployeeLogin where UserName = '" + TextBoxUserName.Text + "'";
            ...
            {
                conn.Open();
                string checkPasswordQuery = "select Password from EmployeeLogin where UserName = '" + TextBoxUserName.Text + "'";
